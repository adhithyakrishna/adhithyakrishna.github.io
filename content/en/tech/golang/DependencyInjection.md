...
This post was inspired by an excellent tech talk by Florian Patan at GopherCon UK in 2018, where he demonstrates creating a Go service in 30 minutes. The interesting takeaway from the talk was the use of dependency injection to pass a logger instance into the handler.
...
```
Note that a new instance of logger has been initialized in line 24. 
...
#### Step 3: Handler method implements the http.Handler interface; the ServeHTTP method contains the code logic where the logger is accessed inside the function.
...
#### Step 4: Instance of handler is initialized and assigned to a variable, then passed to the /home router
